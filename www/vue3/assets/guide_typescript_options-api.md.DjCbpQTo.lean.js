...
<span class="line"><span style="color:#E1E4E8;">  }</span></span>
<span class="line"><span style="color:#E1E4E8;">}</span></span></code></pre></div><p>现在这个 <code>beforeRouteEnter</code> 选项会被准确地标注类型。注意这只是一个例子——像 <code>vue-router</code> 这种类型完备的库应该在它们自己的类型定义中自动执行这些扩展。</p><p>这种类型扩展和全局属性扩展受到<a href="#type-augmentation-placement">相同的限制</a>。</p><p>参考：</p><ul><li><a href="https://github.com/vuejs/core/blob/main/packages/dts-test/componentTypeExtensions.test-d.tsx" target="_blank" rel="noreferrer">对组件类型扩展的 TypeScript 单元测试</a></li></ul>`,46)]))}const d=n(o,[["render",e]]);export{F as __pageData,d as default};
